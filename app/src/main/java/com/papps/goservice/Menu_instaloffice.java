...
public class Menu_instaloffice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_instaloffice);
    ...
    private void keurlwa() {
        kewa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String urlwa = "https://api.whatsapp.com/send?phone=6281213142495&text=hallo saya ingin instalasi office";
                Uri uriwa = Uri.parse(urlwa);
                startActivity(new Intent(Intent.ACTION_VIEW, uriwa));
            }
        });
