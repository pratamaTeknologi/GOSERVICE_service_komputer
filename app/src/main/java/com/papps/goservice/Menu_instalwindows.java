...
public class Menu_instalwindows extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_instalwindows);
    ...
    private void keurlwa() {
        kewa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String urlwa = "https://api.whatsapp.com/send?phone=6281213142495&text=hallo saya ingin instalasi windows";
                Uri uriwa = Uri.parse(urlwa);
                startActivity(new Intent(Intent.ACTION_VIEW, uriwa));
            }
        });
